...
import com.onezero.launcher.launcher.utils.DimenUtils;
...
public class PageIndicatorView extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        dotSize = DimenUtils.dip2px(context, mContext.getResources().getDimension(R.dimen.page_indicator_dot_size));
        margins = DimenUtils.dip2px(context, mContext.getResources().getDimension(R.dimen.page_indicator_dot_size));
    }
